    ...
    <main className="datenschutz">
      ...
      <section>
        ...
        <div>
          ...
          <p>
            Das externe Hosting erfolgt zum Zwecke der Vertragserfüllung
            ...
            oder den Zugriff auf Informationen im Endgerät des Nutzers (z. B.
          ...
          <p>
            ...
            verarbeiten, wie dies zur Erfüllung seiner Leistungspflichten
            erforderlich ist und unsere Weisungen in Bezug auf diese Daten
            befolgen.
          </p>
          <p>Wir setzen folgende(n) Hoster ein:</p>
          <p>Corporate Headquarters 2155 E. GoDaddy Way Tempe, AZ 85284 USA</p>
        </div>
        <div>
          <h3>Auftragsverarbeitung</h3>
          <p>
            Wir haben einen Vertrag über Auftragsverarbeitung (AVV) zur Nutzung
            ...
            gewährleistet, dass dieser die personenbezogenen Daten unserer
      ...
      <section>
        ...
        <div>
          ...
          <p>Oskar Agovic, Unterm Hagen 11, 37079 Göttingen</p>
          <p>
        ...
        <div>
          <h3>
            WAllgemeine Hinweise zu den Rechtsgrundlagen der Datenverarbeitung
            auf dieser Website
          </h3>
          <p>
            ...
            Falle einer ausdrücklichen Einwilligung in die Übertragung
            ...
            eingewilligt haben, erfolgt die Datenverarbeitung zusätzlich auf
            Grundlage von § 25 Abs. 1 TTDSG. Die Einwilligung ist jederzeit
            widerrufbar. Sind Ihre Daten zur Vertragserfüllung oder zur
            Durchführung vorvertraglicher Maßnahmen erforderlich, verarbeiten
            wir Ihre Daten auf Grundlage des Art. 6 Abs. 1 lit. b DSGVO. Des
            Weiteren verarbeiten wir Ihre Daten, sofern diese zur Erfüllung
            ...
            DSGVO erfolgen. Über die jeweils im Einzelfall einschlägigen
        ...
        <div>
          ...
          <p>
            ...
            Wenn diese Tools aktiv sind, können Ihre personenbezogene Daten in
            diese Drittstaaten übertragen und dort verarbeitet werden. Wir
            weisen darauf hin, dass in diesen Ländern kein mit der EU
            ...
            dass Sie als Betroffener hiergegen gerichtlich vorgehen könnten. Es
            kann daher nicht ausgeschlossen werden, dass US-Behörden (z. B.
            Geheimdienste) Ihre auf US-Servern befindlichen Daten zu
            Überwachungszwecken verarbeiten, auswerten und dauerhaft speichern.
            Wir haben auf diese Verarbeitungstätigkeiten keinen Einfluss.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p>
            ENN DIE DATENVERARBEITUNG AUF GRUNDLAGE VON ART. 6 ABS. 1 LIT. E
      ...
      <section>
        ...
        <div>
          ...
          <p>
            ...
            1 lit. b DSGVO, sofern Ihre Anfrage mit der Erfüllung eines Vertrags
            zusammenhängt oder zur Durchführung vorvertraglicher Maßnahmen
            erforderlich ist. In allen übrigen Fällen beruht die Verarbeitung
        ...
        <div>
          ...
          <p>
            ...
            Ihnen an uns per Kontaktanfragen übersandten Daten verbleiben bei
            uns, bis Sie uns zur Löschung auffordern, Ihre Einwilligung zur
            Speicherung widerrufen oder der Zweck für die Datenspeicherung
            entfällt (z. B. nach abgeschlossener Bearbeitung Ihres Anliegens).
      ...
      <section>
        ...
        <div>
          ...
          <p>
            ...
            Besucherzugriffe statistisch auszuwerten. Anbieter ist Veronalabs,
            Tatari 64, 10134, Tallinn, Estland ( https://veronalabs.com).
          </p>
          <p>
            Mit WP Statistics können wir die Nutzung unserer Website
            ...
            der Seite getätigt haben (z. B. Klicks und Ansichten).
          </p>
          <p>
        ...
        <div>
          ...
          <p>
            Wir verwenden WP Statistics mit anonymisierter IP. Ihre IP-Adresse
            wird dabei gekürzt, sodass diese Ihnen nicht mehr direkt zugeordnet
            werden kann.
          </p>
        </div>
      </section>
      <section>
        <h2>6. Plugins und Tools Google reCAPTCHA</h2>
        <p>
        ...
        <p>
          CMit reCAPTCHA soll überprüft werden, ob die Dateneingabe auf dieser
          ...
          Websitebesuchers auf der Website oder vom Nutzer getätigte
          Mausbewegungen). Die bei der Analyse erfassten Daten werden an Google
          weitergeleitet.
        </p>
        <p>
          Die reCAPTCHA-Analysen laufen vollständig im Hintergrund.
        ...
        <p>
          ...
          Interesse daran, seine Webangebote vor missbräuchlicher
          automatisierter Ausspähung und vor SPAM zu schützen. Sofern eine
          entsprechende Einwilligung abgefragt wurde, erfolgt die Verarbeitung
          ausschließlich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO und § 25
          Abs. 1 TTDSG, soweit die Einwilligung die Speicherung von Cookies oder
          den Zugriff auf Informationen im Endgerät des Nutzers (z. B.
          Device-Fingerprinting) im Sinne des TTDSG umfasst. Die Einwilligung
          ist jederzeit widerrufbar.
        </p>
        <p>
          SWeitere Informationen zu Google reCAPTCHA entnehmen Sie den
